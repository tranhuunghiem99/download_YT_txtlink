...
def download_video(url):
    try:
        ...
        video.download('./')  # Thay 'path_to_save_video' bằng đường dẫn thực tế trên máy của bạn
...
with open('./audio/inputlink.txt', 'r') as f:  # Thay 'path_to_your_txt_file' bằng đường dẫn thực tế đến file .txt của bạn
