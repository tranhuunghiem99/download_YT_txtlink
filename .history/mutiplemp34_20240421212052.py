...
def download_video_and_convert_to_audio(url):
    try:
        ...
        # audio_clip.write_audiofile('./audio')  # Thay 'path_to_save_audio/audio.mp3' bằng đường dẫn thực tế trên máy của bạn
...
youtube_urls = ['https://youtu.be/crc-ju7o4XI?si=uoCYRsQTa88ul93s','https://youtu.be/gRAIJ7E_NN0?si=NFRRJY03o-rJJrq5' ]  # Thay 'url1', 'url2', ... bằng các URL video YouTube thực tế của bạn
