...
if __name__ == '__main__':
    input_file = './video/Bất Vấn Biệt Ly - Chỉ Tiêm Tiếu (指尖笑)   YFMOON慢速REMIX.mp4'
    output_file = './audio/audio.mp3'  # Change the file extension based on the desired output format
